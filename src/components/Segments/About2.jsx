              ...
              <div className="col-lg-6 col-md-6 ">
                <div className="m-about-containt text-uppercase text-black p-t30">
                  ...
                  <p className="text-lowercase">
                    ...
                    Guelph, Marilyn quickly established herself among Ontario’s
                    elite luxury homeowners, interior designers, custom home
                    builders, real estate agents, and insurance companies for
                    her beautifully designed custom curtains and soft
                    furnishings.
                  </p>
                  <p className="text-lowercase">
                    For over 30 years, Marilyn has specialized in the tailored
                    creation of hand-sewn curtains, drapes, blinds, and home
                    bedding and accents with the world’s finest fabrics,
                    hardware, and accessories.
                  </p>

                  <p className="text-lowercase">
                    Masterful attention to detail and excellent customer service
                    are woven into the fabric of every piece that leaves
                    Marilyn’s sewing machines. Together with her team of
                    professional seamstresses and installers, Marilyn is
                    defining the exquisite art of custom design and couture
                    window dressings.
                  </p>
                  ...
                  <a
                    href="/#contact"
                    className="btn-half site-button button-lg m-b15 m-r15"
                  >
