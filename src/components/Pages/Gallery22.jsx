              ...
              <div className="container">
                ...
                <div className="row">
                  <div className="col-lg-8 col-md-9 col-sm-12">
                    <p className="p-r30">
                      This is where we showcase our ability to design and create. We
                      invite you to take a closer look at our portfolio and
                      appreciate the level of quality and attention to detail that
                      goes into each of our projects.
                    </p>
                    <p className="p-r30">
                      From modern minimalism to classic elegance, our designs are
                      tailored to suit the unique needs and preferences of each
                      client.
                    </p>
                  </div>
                </div>
